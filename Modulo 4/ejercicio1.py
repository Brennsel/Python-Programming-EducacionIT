...
Desarrollar un programa que cree una base de datos SQLITE3 llamada productos.sqlite 
...
"""
Realizar un programa que permita agregar nuevos productos a la base anterior a 
través de la consola. Se debe solicitar para cada producto 
un id (numerico), un nombre (texto) y un precio (numérico). 
